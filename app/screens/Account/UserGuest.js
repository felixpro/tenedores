...
export default function userGuest() {
	...
	return (<ScrollView centerContent={true} style={styles.viewBody}>
		...
		<Text style={styles.description}>
			Como describirias tu mejor restaurante? busca y vizualiza los mejores restaurantes de una forma sencilla, vota cual te ha gustado mas y comenta como ha sido tu experiencia.
		</Text>
